...
public class Table {
     ...
     * <p>
     * This is efficient, since it only allocates a new {@link ByteBuffer} object, but does not
     ...
     * <p>
     * This is more efficient than using duplicate, since it doesn't copy the data nor allocattes a
